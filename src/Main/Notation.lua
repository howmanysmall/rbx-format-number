...
local Notation_new =
	_internal.class.create_init_function("Notation", nil, Notation, nil, _internal.class.ImmutabilityType.DEFAULT)

local ScientificNotation_methods = {}
local ScientificNotation_new = _internal.class.create_init_function(
	"ScientificNotation",
	"Notation",
	ScientificNotation_methods,
	Notation_methods,
	_internal.class.ImmutabilityType.DEFAULT
)

function ScientificNotation_methods.WithMinExponentDigits(
...
function ScientificNotation_methods.WithExponentSignDisplay(
	self: ScientificNotation,
	exponentSignDisplay: number
): ScientificNotation
	local c_self = _internal.class.try_coerce(1, self, "ScientificNotation")
